...
# PY TITLE BUTTON
class cusTitleButton(QPushButton):
    ...
    def __init__(self,
        ...
        #self._tooltip = _ToolTip(font, app_parent, tooltip_text, dark_one, context_color, text_foreground)
        #self._tooltip.hide()
    ...
    def enterEvent(self, event):
        ...
        #self.move_tooltip()     #自定义Tip
        #self._tooltip.show()    #自定义Tip
