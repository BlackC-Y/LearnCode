...
class PSD_PoseUi():
    ...
    def ToolUi(self):
        ...
        '''
        shiboken2.wrapInstance(int(OmUI.MQtUtil.findControl(styleButton1)), QPushButton).setStyleSheet(style)
        shiboken2.wrapInstance(int(OmUI.MQtUtil.findControl(styleButton2)), QPushButton).setStyleSheet(style)
        shiboken2.wrapInstance(int(OmUI.MQtUtil.findControl(styleButton3)), QPushButton).setStyleSheet(style)
