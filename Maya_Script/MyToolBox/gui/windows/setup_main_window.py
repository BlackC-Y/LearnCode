...
class SetupMainWindow:
    ...
    def setup_gui(self):
        ...
        # ADD GRIPS
        if self.settings["custom_title_bar"]:
            self.left_grip = cusGrips(self, "left", self.hide_grips)
            self.right_grip = cusGrips(self, "right", self.hide_grips)
            self.top_grip = cusGrips(self, "top", self.hide_grips)
            self.bottom_grip = cusGrips(self, "bottom", self.hide_grips)
            self.top_left_grip = cusGrips(self, "top_left", self.hide_grips)
            self.top_right_grip = cusGrips(self, "top_right", self.hide_grips)
            self.bottom_left_grip = cusGrips(self, "bottom_left", self.hide_grips)
            self.bottom_right_grip = cusGrips(self, "bottom_right", self.hide_grips)
        ...
        # ADD Title
        if self.settings["custom_title_bar"]:
            self.ui.title_bar.set_title(u"哔啵哔哔工具箱")
        else:
            self.ui.title_bar.set_title(u"哔啵哔哔工具箱")
        ...
        # BTN 1
        self.right_btn_1 = cusPushButton(
            text="Show Menu 2",
            radius = 4,
            parent = self,
            color=self.themes["app_color"]["text_foreground"],
        ...
        # BTN 2
        self.right_btn_2 = cusPushButton(
            text="Show Menu 1",
            radius = 4,
            parent = self,
            color=self.themes["app_color"]["text_foreground"],
