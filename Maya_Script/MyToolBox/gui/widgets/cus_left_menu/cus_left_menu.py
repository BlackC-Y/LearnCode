...
from MyToolBox.gui.core.functions import *

from .cus_left_menu_button import cusLeftMenuButton
from .cus_div import cusDiv


# PY LEFT MENU
class cusLeftMenu(QWidget):
    # SIGNALS
    ...
    def __init__(self,
        ...
        # ///////////////////////////////////////////////////////////////
        self.toggle_button = cusLeftMenuButton(
            app_parent, 
            text = toggle_text, 
        ...
        # ///////////////////////////////////////////////////////////////
        self.div_bottom = cusDiv(dark_four)
