...
class Ui_ApplePieA(QtWidgets.QMainWindow):
    
    def __init__(self):
        super(Ui_ApplePieA, self).__init__()
        self.setupUi()
    ...
    #        self.close()
    #        print('aa')
    #        #QtWidgets.QWidgetAction.deleteWidget(self.mainWeights)
    #    except:
    #        pass
    #    self.show()

class ApplePieA_pTCIK():
