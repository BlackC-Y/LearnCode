...
from .cus_div import cusDiv
from .cus_title_button import cusTitleButton
...
class cusTitleBar(QWidget):
    ...
    def maximize_restore(self, e = None):
        ...
        def change_ui():
            if _is_maximized:
                ...
                self.maximize_restore_button.setText(u"恢复")
            else:
                ...
                self.maximize_restore_button.setText(u"最大化")
    ...
    def setup_ui(self):
        ...
        # DIVS
        self.div_1 = cusDiv(self._div_color)
        self.div_2 = cusDiv(self._div_color)
        self.div_3 = cusDiv(self._div_color)
        ...
        '''
        # MINIMIZE BUTTON
        self.minimize_button = cusTitleButton(
            self._parent,
            self._app_parent,
            tooltip_text = u"最小化",
            dark_one = self._dark_one,
        ...
        self.maximize_restore_button = cusTitleButton(
            self._parent,
            self._app_parent,
            tooltip_text = u"最大化",
            dark_one = self._dark_one,
        ...
        # CLOSE BUTTON
        self.close_button = cusTitleButton(
            self._parent,
            self._app_parent,
            tooltip_text = u"关闭",
            dark_one = self._dark_one,
            bg_color = self._btn_bg_color,
            bg_color_hover = "#e81123",
            bg_color_pressed = "#f1707a",
            icon_color = self._icon_color,
            icon_color_hover = self._icon_color_hover,
